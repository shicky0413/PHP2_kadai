...
$stmt = $pdo->prepare(
  "INSERT INTO  gs_bm_table( id, realestate_name, price, space,  unit_price, room_type, realestate_url, comment, indate )
  VALUES( NULL, :realestate_name, :price , :space, :unit_price, :room_type, :realestate_url, :comment, sysdate())"
);
